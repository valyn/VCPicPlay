...
//        [self.vcDelegate imagePickerController:self didFinishPickingMediaWithInfo:
//    }
//}
//
...
//        }
//    });
    if ([self.vcDelegate respondsToSelector:@selector(imagePickerController:didFinishPickingMediaWithInfo:)]) {
        [self.vcDelegate imagePickerController:self didFinishPickingMediaWithInfo:info];
    }
}
